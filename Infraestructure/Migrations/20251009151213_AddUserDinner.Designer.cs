...
namespace SNI_Events.Infraestructure.Migrations
{
    ...
    [Migration("20251009151213_AddUserDinner")]
    partial class AddUserDinner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DinnerScheduledEvent", b =>
                {
                    b.Property<long>("DinnersId")
                        .HasColumnType("bigint");

                    b.Property<long>("ScheduledEventsId")
                        .HasColumnType("bigint");

                    b.HasKey("DinnersId", "ScheduledEventsId");

                    b.HasIndex("ScheduledEventsId");

                    b.ToTable("DinnerScheduledEvent");
                });
            ...
            modelBuilder.Entity("DinnerScheduledEvent", b =>
                {
                    b.HasOne("SNI_Events.Domain.Entities.Dinner", null)
                        .WithMany()
